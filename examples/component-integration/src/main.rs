...
use gpui::{
    App, Application, Context, Entity, FocusHandle, Focusable, InteractiveElement, IntoElement,
    KeyBinding, ParentElement, Render, SharedString, Styled, Window, WindowOptions, actions, div,
    prelude::*, px,
};
...
impl ComponentIntegrationApp {
    ...
    fn render_color_swatch(&self, cx: &App, label: String, color: gpui::Hsla) -> impl IntoElement {
